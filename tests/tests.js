...
test('zones is made of a 24 by 24 table', function (t) {
  t.plan(2)
...
test('should throw an error for invalid departureZones', function (t) {
  t.plan(1)
  t.throws(() => { getRate(30, 1, 1) }, /30 is not a valid departureZone/)
  t.end()
})

test('should throw an error for invalid deliveryZones', function (t) {
  t.plan(1)
  t.throws(() => { getRate(1, 31, 1) }, /31 is not a valid deliveryZone/)
  t.end()
})

test('should throw an error for invalid pallet numbers', function (t) {
  t.plan(1)
  t.throws(() => { getRate(1, 1, 15) }, /max pallet number is 14/)
  t.end()
})

test('should default to 1 pallet is none supplied', function (t) {
...
test('should handle pallets between 10 and 14', function (t) {
...
test('some shipping zones are not supported', function (t) {
  t.plan(1)
  t.throws(() => { getRate(16, 16, 1) }, /POA - Prices available on application/)
  t.end()
})

test('should be able to lookup postcodes with Double area codes', function (t) {
...
test('should be able to lookup sub districts that are a single value', function (t) {
...
test('should be able to lookup sub districts in a range', function (t) {
...
test('should throw an error if no zone is found', function (t) {
  t.plan(1)
  t.throws(() => { getZone('XX0 0XX') }, /XX0 0XX is not in a zone/)
  t.end()
})

test('set of postcodes to test', function (t) {
  t.plan(1)
